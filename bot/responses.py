...
Для удобства нашего общения скажите мне в какой вы вообще таймзоне находитесь? Для этого выберите команду /set_timezone. <i><b>Без этого я не стану на вас даже внимание обращать!</b></i>
'''
